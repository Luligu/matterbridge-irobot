...
If you like this project and find it useful, please consider giving it a **star** on [GitHub](https://github.com/Luligu/matterbridge-irobot) and **sponsoring** it.
...
- [battery]: Add battery parser with battery level and charging status.
...
- [devcontainer]: Leave matterbridge scripts in the cloned repo.
- [scripts]: Update mb-run script.
- [matterbridge]: Require matterbridge v.3.7.3.
